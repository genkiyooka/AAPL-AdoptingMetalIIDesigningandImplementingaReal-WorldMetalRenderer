...
class RenderableObject
{
	...
	var scale : vector_float3 = vector_float3(repeating:1.0)
	...
	init()
	{
		...
		self.rotation = vector_float3(0.0, 0.0, 0.0)
		self.rotationRate = vector_float3(0.0, 0.0, 0.0)
	}
	...
	init(m : MTLBuffer, idx : MTLBuffer?, count : Int, tex : MTLTexture?)
	{
		...
		self.objectData = ObjectData()
		self.objectData.LocalToWorld = matrix_identity_float4x4
		self.objectData.color = vector_float4(0.0, 0.0, 0.0, 0.0)
